...
public class RekapAbsen{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RekapAbsen window = new RekapAbsen();
	...
	private void initialize() {
		...
		lblPembayaran.setBounds(10, 0, 86, 20);
		panel_3.add(lblPembayaran);
		...
		JLabel lblHaiKasir = new JLabel("Rekap Absen");
		...
		JLabel lblTransaksi = new JLabel("ID Kasir");
		...
		JLabel lblListPemasukanLaundry = new JLabel("Absensi Karyawan Laundry SonicWash");

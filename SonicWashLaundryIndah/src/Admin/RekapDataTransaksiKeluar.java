...
public class RekapDataTransaksiKeluar{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RekapDataTransaksiKeluar window = new RekapDataTransaksiKeluar();
	 ...
	 */
	public RekapDataTransaksiKeluar() {
		initialize();
	}
	...
	private void initialize() {
		...
		lblTransaksi.setBounds(188, 118, 144, 20);
		...
		JLabel lblListPemasukanLaundry = new JLabel("List Pengeluaran Laundry SonicWash");
